...
st.set_page_config(page_title="Nursing Program Scoring | Jacob Chen", page_icon="◎", layout="wide")
...
st.markdown("""<div class='hero'><div class='eyebrow'>NURSING EDUCATION RECRUITMENT</div><h1>Nursing Program Scoring</h1><p>Predict enrollment likelihood for nursing higher education applicants using demographic, financial, campaign, and historical data.</p></div>""")
